  ...
  return (
    <canvas
      ...
      style={{
        ...
        height: '100%',
        pointerEvents: 'none',
        opacity: overlayMode === 'multiply' || overlayMode === 'multiplyNormalized' ? 1.0 : 0.8,
...
const AttentionMapGrid = memo(({ 
  ...
  return (
    <Flex ref={containerRef} gap={0} flexWrap="wrap" h="full">
...
const InteractiveImage = memo(({ 
  ...
  // Track the actual rendered image dimensions
