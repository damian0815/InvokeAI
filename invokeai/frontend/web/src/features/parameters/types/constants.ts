...
export const SCHEDULER_OPTIONS: ComboboxOption[] = [
  ...
  { value: 'euler_flowmatch_shift1', label: 'Euler Flow Matching shift=1' },
  { value: 'euler_flowmatch_shift3', label: 'Euler Flow Matching shift=3' },
  { value: 'euler_flowmatch_dynshift', label: 'Euler Flow Matching shift=dynamic' },
  { value: 'heun', label: 'Heun' },
  { value: 'heun_k', label: 'Heun Karras' },
  { value: 'heun_flowmatch_shift1', label: 'Heun Flow Matching shift=1' },
  { value: 'heun_flowmatch_shift3', label: 'Heun Flow Matching shift=3' },
  { value: 'heun_flowmatch_dynshift', label: 'Heun Flow Matching shift=dynamic' },
